    ...
    return (
        <React.Fragment>
            ...
            <div className="home-campaign-qph overflow-afe" id="campaign-root">
                ...
                <div className="home-campaign-git-ej8 height-tt5 
                rou-mzj build-in-scale-aec build-in-qxd style-gm3If" id="style-gm3If">
                ...
                <div className="pan-cont">
                <div className="pan-cont-inner">
                <h2 className="pan-title">Common Documents & Licensure</h2>
                </div>
                </div>
                </div>
                </div>
...
<div className="col-wsx d-6fb column-vo5 item-skx">
<div className="mb-x3j position-4nl icon-6mt">
<span className="position-3th left-lo4 top-g6e height-tt5 width-ntz icon-qvb cir-ldk z-r2g style-KGYh7"
id="style-KGYh7"></span>
</div>
